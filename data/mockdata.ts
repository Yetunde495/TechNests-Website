...
export const blogPosts = [
  {
    ...
    excerpt:
      "Discover how machine learning algorithms are revolutionizing the way we identify and execute profitable trades.",
    ...
    image:
      "https://images.pexels.com/photos/373543/pexels-photo-373543.jpeg?auto=compress&cs=tinysrgb&w=400&h=250&fit=crop",
  },
  {
    id: "crypto-trading-automation",
    title: "Automating Cryptocurrency Trading: Best Practices",
    excerpt:
      "Essential tips and strategies for successful automated cryptocurrency trading in volatile markets.",
    ...
    image:
      "https://images.pexels.com/photos/844124/pexels-photo-844124.jpeg?auto=compress&cs=tinysrgb&w=400&h=250&fit=crop",
  },
  {
    id: "market-volatility-strategies",
    title: "Trading Strategies for High Volatility Markets",
    excerpt:
      "How to adapt your trading approach during periods of extreme market volatility and uncertainty.",
    author: "Emily Parker",
    authorAvatar:
    ...
    image:
      "https://images.pexels.com/photos/669610/pexels-photo-669610.jpeg?auto=compress&cs=tinysrgb&w=400&h=250&fit=crop",
  },
  {
    id: "backtesting-trading-strategies",
    title: "The Complete Guide to Backtesting Trading Strategies",
    excerpt:
      "Learn how to properly test your trading strategies using historical data to improve performance.",
    author: "Michael Chen",
    authorAvatar:
  ...
  },
  {
    ...
    excerpt:
      "Understanding the mental aspects of trading and how automation can help overcome emotional biases.",
    author: "Sarah Johnson",
    authorAvatar:
      "https://images.pexels.com/photos/774909/pexels-photo-774909.jpeg?auto=compress&cs=tinysrgb&w=150&h=150&fit=crop",
    date: "2024-01-03",
  ...
  },
  {
    ...
    excerpt:
      "Optimize your trading schedule by understanding when different forex markets are most active.",
    author: "David Rodriguez",
    authorAvatar:
      "https://images.pexels.com/photos/1239291/pexels-photo-1239291.jpeg?auto=compress&cs=tinysrgb&w=150&h=150&fit=crop",
    date: "2024-01-01",
    ...
    category: "Forex",
    image:
      "https://images.pexels.com/photos/730547/pexels-photo-730547.jpeg?auto=compress&cs=tinysrgb&w=400&h=250&fit=crop",
  },
];
...
export const faqData = [
  {
    ...
    answer:
      "Technests is a local AI-powered automation platform that helps prop firm traders pass evaluations, stay funded, and trade consistently by automating their trading rules.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "No. Technests doesn’t provide capital — it helps you earn and keep it by improving your execution, discipline, and rule adherence.",
  },
  {
    question: "Is this copy trading or signals?",
    answer:
      "No. Technests is not a signal provider or copy trading system. Your bot runs your strategy, locally and independently.",
  },
  {
    question: "What platforms does it support?",
    answer:
      "Technests currently integrates with NinjaTrader for futures trading and is compatible with firms like Apex, Topstep, and Earn2Trade.",
  },
  {
    question: "Can I run multiple accounts?",
    answer:
      "Yes. Technests supports multi-account automation so you can trade several evaluations or funded accounts simultaneously.",
  },
  {
    question: "Is it cloud-based?",
    answer:
      "No. Technests runs locally on your device, ensuring low latency, privacy, and direct control over your trades.",
  },
];
...
export const subscriptionPlans = {
  ...
  plans: [
    {
      ...
      cta: {
        ...
        link: "https://buy.stripe.com/7sIdUPcxO3zp9gc8wH",
      },
    },
    {
      id: "growth",
      ...
      cta: {
        ...
        link: "https://buy.stripe.com/cN25oj0P62vlbokaEQ",
      },
      popular: true,
    },
    {
      ...
      yearlySavings: 365,
      tagline:
        "Best for prop firms, power users, or serious traders running large systems.",
      icon: ShieldCheck,
      features: [
      ...
      cta: {
        ...
        link: "https://buy.stripe.com/14kcQLfK02vl0JGaER",
      },
    },
  ],
  ...
  extras: {
    guarantee:
      "All plans include full access, no hidden fees, and zero lock-in.",
